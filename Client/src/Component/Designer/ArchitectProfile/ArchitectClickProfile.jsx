  ...
  return (
    <section className="profilePage">
      <div className="header_wrapper">
        ...
        {!isEmpty(db) ? <div className="col_container">
          <div className="left_col">
            <div className="img_container">
              <img src={`http://localhost:3005/${db.interiorDesignerProfile}`} alt="Profile Picture" />
            </div>
            <h2 className="profileHeader">{db.interiorDesignerName}</h2>
            <p className="profileDesignerDetail">{db.type}</p>
            <p className="profileDesignerDetail">{db.interiorDesignerEmail}</p>
            {/* <ul className="profile_about">
              <li>
                <span>175</span>Designs
              </li>
            ...
            <div className="profile_contant">
              <p>
                <h4 className="mobno">MO: {db.interiorDesignerPhone}</h4>
                <h5 className="mobno">GST No: {db.interiorDesignerGst}</h5>
                <address>
                  {db.interiorDesignerAdd}
                  <br /> {db.interiorDesignerCity}-{db.interiorDesignerPincode},
                  <br /> {db.interiorDesignerState}
                  <br /> 📍 {db.interiorDesignerCountry}
                </address>
              </p>
            </div>
          </div>
